...
export default function SignUp({ onNavigate }) {
  ...
  return (
    <div className="max-w-md mx-auto  p-8 bg-card-bg border border-border rounded-2xl text-text-main shadow-xl relative overflow-hidden">
      ...
      <p className="text-sm text-text-muted mt-1 mb-6">Get started with tracking and tailoring your career applications.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-xs font-semibold uppercase tracking-wider text-text-muted mb-1.5">Confirm Password</label>
          <input
            type="password"
            required
      ...
      <p className="text-xs text-text-muted mt-6 text-center">
        ...
        <button onClick={() => onNavigate('login')} className="text-primary hover:underline font-semibold cursor-pointer">
          Log In
        </button>
      </p>
    </div>
